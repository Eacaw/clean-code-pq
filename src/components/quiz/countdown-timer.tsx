...
export default function CountdownTimer({ startTime, duration, onTimerEnd, isDisabled = false }: CountdownTimerProps) {
  ...
  return (
    <div className={`flex items-center gap-1 px-2 py-1 rounded-md bg-gray-800 ${getTimerColor()}`}>
      <Clock size={14} />
